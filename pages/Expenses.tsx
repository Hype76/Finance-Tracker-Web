    ...
    <div className="space-y-6">
      ...
      {isAdding && (
        <Card className="p-6 animate-in slide-in-from-top-4 duration-200 border-l-4 border-l-red-500">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Input label="Date Paid" type="date" {...register('date_paid')} error={errors.date_paid?.message} />
              <Select 
                label="Category" 
            ...
            <Input label="Notes (Optional)" {...register('notes')} placeholder="Details..." />
            
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700">Receipt/Invoice (Optional)</label>
            ...
            <div className="flex justify-end pt-2">
              <Button type="submit" variant="danger" isLoading={mutation.isPending || uploading}>Record Expense</Button>
            </div>
          </form>
        </Card>
      )}
      ...
      <Card className="overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-8 text-center text-gray-500">No expense entries found.</div>
        ) : (
